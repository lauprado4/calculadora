...
if (operacion === "sumar" || operacion === "restar" || operacion === "multiplicar" || operacion === "dividir"){
    numero1 = parseInt(prompt("Ingrese el número a " + operacion +"."));
    numero2 = parseInt(prompt("Ingrese el segundo número que quiera " + operacion +"."));
}
else {
...
let segundaOperacion = confirm("Quieres hacer otra operación?")
    do {
        operacion = prompt(nombre + ", ¿Desea sumar, restar, multiplicar o dividir?");
        numero1 = parseInt(prompt("Ingrese el número a " + operacion +"."));
        numero2 = parseInt(prompt("Ingrese el segundo número que quiera " + operacion +"."));
        calculo();
    }
